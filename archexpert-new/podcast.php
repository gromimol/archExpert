...
<main class="main">
            ...
            <div class="inner-page__content">
                <div class="podcast__content__body">
                    ...
                    <ul class="podcast-links">
                        <li><a href="https://podcasts.apple.com/podcast/id1821879503 " target="_blank"><img src="<?php echo esc_url( set_url_scheme( get_stylesheet_directory_uri() . '/assets/images/podcast/podcast_link_1.svg', 'https' ) ); ?>" alt=""></a></li>
                        <li><a href="https://open.spotify.com/show/4VODUSuJg85EvUfA3fjKcW" target="_blank"><img src="<?php echo esc_url( set_url_scheme( get_stylesheet_directory_uri() . '/assets/images/podcast/podcast_link_2.svg', 'https' ) ); ?>" alt=""></a></li>
    ...
    <section class="final-cta final-cta--visible">
        ...
        <div class="container">
            ...
            <ul class="podcast-links">
                <li><a href="https://podcasts.apple.com/podcast/id1821879503" target="_blank" class="podcast-link"><img src="<?php echo esc_url( set_url_scheme( get_stylesheet_directory_uri() . '/assets/images/podcast/podcast_link_1.svg', 'https' ) ); ?>" alt=""> Apple Podcasts</a></li>
                <li><a href="https://open.spotify.com/show/4VODUSuJg85EvUfA3fjKcW" target="_blank" class="podcast-link"><img src="<?php echo esc_url( set_url_scheme( get_stylesheet_directory_uri() . '/assets/images/podcast/podcast_link_2.svg', 'https' ) ); ?>" alt="" >Sign in with Spotify</a></li>
